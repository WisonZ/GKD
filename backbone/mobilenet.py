...
class MobileFaceNet(Module):
    def __init__(self, fp16=False, num_features=512, blocks=(1, 4, 6, 2), scale=2,num_classes=93431,feat=False):
...
def get_mbf(fp16, num_features, blocks=(1, 4, 6, 2), scale=2,num_classes = 93232):
    return MobileFaceNet(fp16, num_features, blocks, scale=scale,num_classes=num_classes)


def get_mbf_large(fp16, num_features, blocks=(2, 8, 12, 4), scale=4,num_classes=93232):
    return MobileFaceNet(fp16, num_features, blocks, scale=scale,num_classes=num_classes)